...
class wptypo
{
	 ...
	 *
	 * @see wptypo::set_options()  to obtain the saved
	 *      settings
	 * @var array
	 */
	 ...
	 * @return void
	 *
	 * @uses wptypo::set_options()  to replace the default
	...
	protected function createFixer( $fixOptions ) {
		...
		if ( $fixOptions['fix_smart_quotes'] ) {
			array_push( $fixers, 'SmartQuotes' ); }
	...
	protected function load_plugin_textdomain() {
		...
		if ( ! $this->loaded_textdomain ) {
			load_plugin_textdomain( 'wptypo', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' );
